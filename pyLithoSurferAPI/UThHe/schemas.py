...
class HeDataPointSchema(pa.SchemaModel):
    ...
    id: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    insituHeTechniqueId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    insituHeTechniqueName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
    insituParentTechniqueId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    insituParentTechniqueName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
    ...
    numAliquots: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    pitMeasuringTechniqueId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    pitMeasuringTechniqueName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
    pitVolumeSoftwareId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    pitVolumeSoftwareName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
...
class HeInSituSchema(pa.SchemaModel):
    ...
    parentPitVolumeUncertainty: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    parentPitVolumeUncertaintyTypeId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    parentPitVolumeUncertaintyTypeName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
    ...
    pitVolumeUncertaintyTypeId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    pitVolumeUncertaUncertainty: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    pitVolumeUncertaintyTypeName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
    smAmount: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    smAmountUncertainty: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    smAmountUncertaintyTypeId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    smAmountUncertaintyTypeName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
