...
class HeWholeGrainSchema(pa.SchemaModel):
    ...
    avgGrainHeightSD: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    avgGrainLengthSD: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    avgGrainSurfaceAreaSD: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    avgGrainVolumeSD: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    avgGrainWidthSD: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    ...
    grainGeometryId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    grainGeometryName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
    grainHeight: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    grainLength: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    grainMorphologyId: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    grainMorphologyName: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
    grainSurfaceArea: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    grainVolume: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    grainWidth: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
