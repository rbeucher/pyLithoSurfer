...
class FTBinnedLengthDataSchema(pa.SchemaModel):
    ...
    i0x1: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i10x11: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True) 
    i11x12: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i12x13: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i13x14: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i14x15: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i15x16: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i16x17: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i17x18: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i18x19: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i19x20: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i1x2: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i2x3: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i3x4: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i4x5: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i5x6: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i6x7: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i7x8: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i8x9: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
    i9x10: Optional[Series[pa.Int]] = pa.Field( nullable=True, coerce=True)
...
class FTLengthDataSchema(pa.SchemaModel):
    ...
    cAcisAngle: Optional[Series[pa.Float]] = pa.Field( nullable=True, coerce=True)
    cfIrradiation: Optional[Series[pa.Bool]] = pa.Field( nullable=True, coerce=True)
    comment: Optional[Series[pa.String]] = pa.Field( nullable=True, str_length={"max_value": 255})
